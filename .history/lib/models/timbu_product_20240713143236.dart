...
class ProductResponse {
  ...
  factory ProductResponse.fromJson(Map<String, dynamic> json) {
    ...
    List<Product> items = itemsList.map((i) => Product.fromJson(i)).toList();
...
class Product {
  ...
  factory Product.fromJson(Map<String, dynamic> json) {
    ...
    List<Price> currentPrice = currentPriceList.map((i) => Price.fromJson(i)).toList();
...
class Price {
  ...
  factory Price.fromJson(Map<String, List<dynamic>> json) {
