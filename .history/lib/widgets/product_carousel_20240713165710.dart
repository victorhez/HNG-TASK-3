...
class _ProductCarouselState extends State<ProductCarousel> {
  ...
  final PageController _pageController = PageController(viewportFraction: 0.53);
        ...
        children: [
          ...
          SizedBox(
            ...
            child: PageView.builder(
                ...
                }).length, // Number of items in the carousel
                itemBuilder: (context, index) {
                  return Container(
                      ...
                      child:
                          ProductCard(product: widget.products.items[index]));
                }),
          ),
          // CarouselSlider(
          //   items: widget.products.items.where((element) {
          //     return widget.keyword.any((keyword) =>
